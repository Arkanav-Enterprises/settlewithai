...
faq:
  - question: "What logistics workflows can Claude handle?"
  ...
  - question: "Can Claude handle customs and compliance documentation?"
    answer: "Claude can draft customs declarations, compliance reports, and regulatory filings based on your shipment data and requirements. Every project includes mandatory review gates — your compliance team verifies before submission."
  - question: "Can Claude connect to our TMS or WMS?"
    answer: "Via MCP (Model Context Protocol), Claude integrates with systems that have APIs or structured data exports. Settle configures the pipeline between your transportation/warehouse management system and Claude projects."
  - question: "How does this help with vendor management?"
    answer: "Settle builds Claude projects for vendor communication — RFQ generation, performance scorecards, rate comparisons, and contract review drafts. Consistent, data-driven vendor management across your entire network."
  ...
  - question: "What about multi-language documentation?"
    answer: "Claude handles multiple languages natively. Settle can engineer projects that generate documentation in the languages your supply chain requires — shipping docs, vendor comms, customs filings."
---
...
- **Safety rules** that prevent Claude from submitting documents, making compliance determinations, or operating outside defined boundaries
