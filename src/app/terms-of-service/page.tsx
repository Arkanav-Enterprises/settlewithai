    ...
    <>
      ...
      <main className="max-w-[720px] mx-auto px-6 lg:px-10 pt-32 pb-24 md:pt-40 md:pb-36">
        ...
        <div className="prose prose-neutral max-w-none text-[17px] leading-[1.8] [&_h2]:text-[1.35rem] [&_h2]:font-medium [&_h2]:mt-12 [&_h2]:mb-4 [&_p]:mb-6 [&_ul]:mb-6 [&_ul]:ml-6 [&_li]:mb-2">
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Agreement to terms</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Services</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Use of the Site</h2>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Intellectual property</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Interactive tools</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Third-party links</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Disclaimer of warranties</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Limitation of liability</h2>
          <p>
          ...
          <h2 style={{ fontFamily: "Sentient, Georgia, serif" }}>Governing law</h2>
          <p>
